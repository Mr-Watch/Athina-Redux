...
public class Controler {
    ...
    public String getSubjectInfo(String selectedItem) {
        ...
        return "Δεν βρέθηκαν πληροφορίες για το μάθημα.";
    }
    ...
    public boolean makeTeacherRequest(String studentName, String subjectName, float grade) {
       ArrayList<Request> requestsRead = ObjectReader.readObjects("Request");
        Request newRequest = teacher.makeRequestToChangeGrade(teacher.getTeacherName(), studentName, subjectName, grade);
        if (newRequest.isEmpty()) {
            return false;
        }
        requestsRead.add(newRequest);
    ...
    public String getStudentStats(DefaultTableModel model, int studentcount) {
        ...
        return teacher.computeStudentStats(studentsGrades);
    }
