...
public class Athina {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        Subject sub1 = new Subject("Mathmatika", "Mathimatika", 1234, 6, 2);
        Subject sub2 = new Subject("Programatismos", "Programatismos", 1030, 6, 2);
        Subject sub3 = new Subject("Grafika", "Grafika", 5432, 6, 2);
        Subject sub4 = new Subject("Dedomena","Dedomena",1013,6,2);
        Subject sub5 = new Subject("Mathimatika 2","Mathimatika 2",1010,6,3);
        Subject sub6 = new Subject("Psifiaka","Psifiaka",1080,6,3);
        
        Teacher teacher1 = new Teacher("Teacher123","123","Mpampis Lampros","Pola xronia empiria");
        Teacher teacher2 = new Teacher("Sakisthe", "321", "Sakis nixotos", "Misi tis deuteres");
        ...
        Student student1 = new Student("it174973", "204571", "Sarantis Syrakis", 2);
        Student student2 = new Student("it174909", "133", "Dimitris Symeonidis", 2);
        ...
        Grammatia grammatia = new Grammatia("grammatiauser", "789");
